...
def customized_train(samples_proportion=0.8):
    ...
    print('Enter support value to calculate frequent words')
    support = input()

    spam_support_count = spam_size * support / 100
    ham_support_count = ham_size * support / 100
    ...
    spam_frequent, ham_frequent = Preprocessor.get_frequent(features, spam_support_count, ham_support_count)
    ...
    get_tweaked_probabilies(spam_frequent, ham_frequent, spam_size, ham_size, spam_vocab, ham_vocab)
...
def get_tweaked_probabilies(spam_frequent, ham_frequent, spam_total, ham_total, spam_vocab, ham_vocab):
    ...
    return raw_spam_prob, raw_ham_prob
